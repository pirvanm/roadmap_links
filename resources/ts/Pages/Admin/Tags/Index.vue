                ...
                <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                        ...
                        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                            <tr v-for="(tag, tagIndex) in tags" :key="'tag-' + String(tagIndex)" class="hover:bg-gray-50">
                                <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                    <div class="font-medium text-gray-700">{{ tag.id }}</div>
                                </th>
                                <td class="px-6 py-4 text-center">{{ tag.tag }}</td>
                                <td class="px-6 py-4 flex justify-center">
                                    <span v-if="tag.status" class="inline-flex items-center gap-1 rounded-full bg-green-50 px-2 py-1 text-xs font-semibold text-green-600">
