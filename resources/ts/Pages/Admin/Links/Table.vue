        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
            <tr v-for="(link, linkIndex) in links" :key="'link-' + String(linkIndex)" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 flex justify-center">
                    <span v-if="Number(link.status)" class="inline-flex items-center gap-1 rounded-full bg-green-50 px-2 py-1 text-xs font-semibold text-green-600">
                        <span class="h-1.5 w-1.5 rounded-full bg-green-600"></span>
                        Active
                    </span>
                    <span v-else class="inline-flex items-center gap-1 rounded-full bg-green-50 px-2 py-1 text-xs font-semibold text-red-600">
